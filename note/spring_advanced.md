...
![image-20221006160150009](https://picgo-1259245122.cos.ap-shanghai.myqcloud.com/img/note/ssm/202210061601956.png)

- 查看类图：ctrl+alt+u
- 查看接口所有方法：ctrl+f12

![image-20221006165923488](https://picgo-1259245122.cos.ap-shanghai.myqcloud.com/img/note/ssm/202210061659601.png)
...
![image-20221007221740267](https://picgo-1259245122.cos.ap-shanghai.myqcloud.com/img/note/ssm/202210072217921.png)
...
if (componentScan != null) {
    for (String s : componentScan.basePackages()) {
        ...
        // System.out.println(resource);
            ...
            System.out.println("是否加了@Component:" + annotationMetadata.
                  hasAnnotation(org.springframework.stereotype.Component.class.getName()));
            System.out.println("是否加了@Component的派生注解：" + annotationMetadata.
                  hasMetaAnnotation(org.springframework.stereotype.Component.class.getName()));
            System.out.println("--------------------------------------------");


            // 1.判断是否添加了注解（包括component及其派生注解）
            // 2.生成一个对应的BeanDefinition
            // 3.生成bean工厂的名字
            // 4.生成对应的bean工厂
            if (annotationMetadata.hasAnnotation(org.springframework.stereotype.Component.class.getName())
             || annotationMetadata.hasMetaAnnotation(org.springframework.stereotype.Component.class.getName())){
...
![image-20221008202905518](https://picgo-1259245122.cos.ap-shanghai.myqcloud.com/img/note/ssm/202210082029124.png)
...
-javaagent:D:/apache-maven-3.6.3/repository/org/aspectj/aspectjweaver/1.9.7/aspectjweaver-1.9.7.jar
...
![image-20221017091936539](https://picgo-1259245122.cos.ap-shanghai.myqcloud.com/img/note/ssm/202210170919255.png)
...
response.setContentType > request.addHeader > MessageConverter的添加顺序   MediaType的顺序
...
- RouterFunctionMapping搜集所有RouterFunction，包括两大部分：
  - RequestPredicate设置映射条件
  - HandlerFunction包括处理逻辑
...
<img src="F:/study/graduate/java/spring/文档/文档/img/image-20211021160145072.png" alt="image-20211021160145072" style="zoom: 50%;" />

接下来勾选 Spring Web 支持

<img src="F:/study/graduate/java/spring/文档/文档/img/image-20211021162416525.png" alt="image-20211021162416525" style="zoom:50%;" />
